...
export const metadata: Metadata = {
  title: "Mureli Coffee Shop | Premium Coffee & Cozy Atmosphere",
  description: "Premium coffee crafted with passion at Mureli. Discover our signature blends, cozy ambiance, and expert baristas. Visit us today.",
  keywords: "coffee shop, specialty coffee, espresso, cappuccino, cafe, premium coffee",
  metadataBase: new URL("https://mureli-coffee.com"),
  alternates: {
    canonical: "https://mureli-coffee.com"
  },
  openGraph: {
    title: "Mureli Coffee Shop | Premium Coffee & Cozy Atmosphere",
    description: "Premium coffee crafted with passion. Your daily escape in every cup.",
    url: "https://mureli-coffee.com",
    siteName: "Mureli Coffee Shop",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766072256607-48o3q63l.jpg",
        alt: "Mureli Premium Coffee"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Mureli Coffee Shop | Premium Coffee",
    description: "Premium coffee crafted with passion. Your daily escape in every cup.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766072256607-48o3q63l.jpg"]
  },
  robots: {
    index: true,
    follow: true
